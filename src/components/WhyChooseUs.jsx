        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {ADVANTAGES.map((item, index) => (
            ...
            >
              <div
                className="
                  group relative h-full p-8 rounded-2xl text-center
              ...
              >
                {/* Number watermark */}
                <span className="block text-5xl font-extrabold text-slate-100 mb-3 select-none group-hover:text-emerald-100 transition-colors duration-300">
                  {item.number}
                </span>
                ...
                <div
                  className="
                    ...
                    bg-emerald-50 text-emerald-700 mb-4
                ...
                {/* Bottom accent */}
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 h-0.75 w-0 group-hover:w-12 bg-emerald-500 rounded-full transition-all duration-500" />
              </div>
            </AnimatedSection>
          ))}
        </div>
