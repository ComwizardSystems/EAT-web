          ...
          <AnimatedSection animation="fade-up" delay={100}>
            <div className="relative bg-white/80 backdrop-blur-lg rounded-3xl p-10 md:p-12 border border-white/60 shadow-xl shadow-slate-200/50">
              ...
              <div className="relative z-10 text-center">
                <div
                  className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-linear
                  -to-br from-emerald-500 to-emerald-600 text-white mb-6 shadow-lg shadow-emerald-500/30"
                >
                  <svg
                    className="w-8 h-8"
                    fill="none"
